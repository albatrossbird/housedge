...
// Number(null) IS 0, AND 0 IS A CLAIM. The `/markets` feed this recorder
// polls carries no size on the 15-minute family, so `yes_bid_size`
// arrives null — and a null coerced to zero reads as "nothing offered at
// the touch", which is a statement about the book rather than about what
// we know. The book itself is NOT empty: `/markets/<ticker>/orderbook`
// publishes the full ladder on every side. The null is a fact about the
// endpoint we read, never about the market. Same trap that made
